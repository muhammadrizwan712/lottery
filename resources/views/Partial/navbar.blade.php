              ...
              <div class="container">
                    ...
                    <div class="navbar-header">
                      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1">
                        ...
                        <div class="logo">
                            <h1><a class="navbar-brand" href="index.html"><span>L</span>OTTERY HUNTERS </a></h1>
                        </div>
                    </div>
                          ...
                          <div class="top-menu">
                            <nav class="menu menu--francisco">
                                    <ul class="nav navbar-nav menu__list">
                                        ...
                                        <li class="menu__item"><a href="/login" class="menu__link"><span class="menu__helper">Sign in</span></a></li>
                                        <li class="menu__item"><a href="/register" class="menu__link"><span class="menu__helper">Sign up</span></a></li>
